...
def vardok_concept_variables_by_approved(internal: bool = False) -> OrderedDict[str, Any]:
...
def vardok_concept_variables_by_external_source(var_id: str | int) -> OrderedDict[str, Any]:
...
def vardok_concept_variables_by_internal_source(var_id: str | int) -> OrderedDict[str, Any]:
...
def vardok_concept_variables_by_statistical_unit(statistical_unit: str | int) -> OrderedDict[str, Any]:
    ...
    Returns:
        OrderedDict: The serialized zeep OrderedDict.
    """
    return get_zeep_serialize("vardok", "GetConceptVariablesByStatisticalUnit", statistical_unit)

def vardok_concept_variables_by_subject_area(subject_area: str | int) -> OrderedDict[str, Any]:
    """Rutinen skal returnere det samme som GetConceptVariableById for en oppgitt telleenhet.
    ...
    Returns:
        OrderedDict: The serialized zeep OrderedDict.
    """
    return get_zeep_serialize("vardok", "GetConceptVariablesBySubjectArea", subject_area)

def vardok_version_by_concept_variable_id(variable_id: str | int) -> OrderedDict[str, Any]:
